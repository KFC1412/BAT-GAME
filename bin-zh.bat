...
set input=
set /p input=语言 选择:
IF "%input%"=="1" del loadbug.txt&del 开始游戏.bat&ren GAME-zh.bat 开始游戏.bat&start 开始游戏.bat&exit
